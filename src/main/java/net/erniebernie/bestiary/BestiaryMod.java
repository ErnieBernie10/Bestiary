...
public class BestiaryMod implements ModInitializer {
    ...
    public static final ComponentType<CounterComponent> KILLS_COMPONENT = ComponentRegistry.INSTANCE.registerIfAbsent(new Identifier("fabric-bestiary:kills"), CounterComponent.class);
